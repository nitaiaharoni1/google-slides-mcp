...
describe('Tools Module', () => {
  describe('getToolDefinitions', () => {
    ...
    test('should include database type information in descriptions', () => {
      ...
      tools.forEach(tool => {
        // Most tools should mention supported databases
        const description = tool.description.toLowerCase();
        const mentionsDatabase = description.includes('postgresql') || 
  ...
  describe('Tool Input Schema Validation', () => {
    ...
    test('describe_table should have correct schema', () => {
      ...
      expect(describeTool!.inputSchema.properties.table_name.type).toBe('string');
    });
