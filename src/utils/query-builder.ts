...
export class QueryBuilder {
  ...
  static buildExplainQuery(
    ...
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for EXPLAIN: ${databaseType}`,
        );
    }
  }
  ...
  static buildColumnStatsQuery(
    ...
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for column stats: ${databaseType}`,
        );
    }
  }
   ...
   */
  static buildMostCommonValuesQuery(
    databaseType: DatabaseType,
    tableName: string,
    columnName: string,
    limit: number = 10,
    ...
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for most common values: ${databaseType}`,
        );
    }
  }
  ...
  static escapeIdentifier(
    ...
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for identifier escaping: ${databaseType}`,
        );
    }
  }
  ...
  static buildTableFilter(
    ...
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for table filter: ${databaseType}`,
        );
    }
  }
}
...
export class ExplainResultParser {
  ...
  static parseExplainResult(databaseType: DatabaseType, rows: any[]): any[] {
    switch (databaseType) {
      ...
      default:
        throw new Error(
          `Unsupported database type for EXPLAIN parsing: ${databaseType}`,
        );
    }
  }
}
