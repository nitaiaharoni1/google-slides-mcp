...
const describeTable = async (args: DescribeTableArgs) => {
  ...
  console.error(
    `🔍 Describing table '${tableName}' for ${dbType?.toUpperCase()}`,
  );
  ...
  console.error(
    `✅ Table '${tableName}' has ${columnResult.rows.length} columns`,
  );
    ...
    return formatSuccessResult(
      {
        functions: [],
        message:
          'User-defined functions not supported for introspection in SQLite',
        databaseType: dbType,
      },
      dbType,
    );
...
export const schemaTools: MCPToolDefinition[] = [
  {
    name: 'list_tables',
    description:
      'List all tables and views in the database. Works with PostgreSQL, MySQL, and SQLite.',
    inputSchema: {
      type: 'object',
      properties: {},
      required: [],
  ...
  },
  {
    name: 'describe_table',
    description:
      'Get detailed information about a specific table including columns and constraints. Works with PostgreSQL, MySQL, and SQLite.',
    inputSchema: {
      type: 'object',
      properties: {
        table_name: {
  ...
  },
  {
    name: 'list_schemas',
    description:
      'List all schemas in the database. Works with PostgreSQL, MySQL, and SQLite.',
    inputSchema: {
      type: 'object',
      properties: {},
      required: [],
  ...
  },
  {
    name: 'list_indexes',
    description:
      'List database indexes, optionally filtered by table name. Works with PostgreSQL, MySQL, and SQLite.',
    inputSchema: {
      type: 'object',
      properties: {
        table_name: {
  ...
  },
  {
    ...
    description:
      'Get foreign key relationships, optionally filtered by table name. Works with PostgreSQL and MySQL.',
    inputSchema: {
      type: 'object',
      properties: {
        table_name: {
  ...
  },
  {
    name: 'list_functions',
    description:
      'List user-defined functions and procedures. Works with PostgreSQL and MySQL.',
    inputSchema: {
      type: 'object',
      properties: {
        schema_name: {
          type: 'string',
          description:
            'Optional schema name to filter functions (defaults to public/current schema)',
        },
      },
      required: [],
    },
