  ...
  try {
    ...
    const baseConfig = {
      ...
      external: [
        ...
        'sqlite',
        'dotenv',
        'open',  // Browser opening - has native dependencies
        'google-auth-library',  // Google auth - complex module
        'googleapis'  // Google APIs - complex module
      ],
      define: {
        'process.env.NODE_ENV': '"production"',
        '__PACKAGE_VERSION__': `"${packageJson.version}"`,
        'require.main': 'undefined'  // Fix for bundled code
      },
      treeShaking: true,
      loader: {
        '.json': 'json'
